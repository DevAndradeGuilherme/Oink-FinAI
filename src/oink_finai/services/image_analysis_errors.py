...
class GroundingFailureReason(StrEnum):
    ...
    WARNING_NONE_CONFLICT = "WARNING_NONE_CONFLICT"
    DUPLICATE_WARNINGS = "DUPLICATE_WARNINGS"
    MULTIPLE_AMOUNTS_WARNING_MISSING = "MULTIPLE_AMOUNTS_WARNING_MISSING"
    MULTIPLE_DATES_WARNING_MISSING = "MULTIPLE_DATES_WARNING_MISSING"
