...
class GroundingFailureReason(StrEnum):
    ...
    CANDIDATES_ON_UNREADABLE_IMAGE = "CANDIDATES_ON_UNREADABLE_IMAGE"
    CANDIDATES_ON_NON_FINANCIAL_IMAGE = "CANDIDATES_ON_NON_FINANCIAL_IMAGE"
    DUPLICATE_CANDIDATE = "DUPLICATE_CANDIDATE"
    DOCUMENT_TYPE_CONFLICT = "DOCUMENT_TYPE_CONFLICT"
    DOMAIN_CONTRACT_CONFLICT = "DOMAIN_CONTRACT_CONFLICT"
